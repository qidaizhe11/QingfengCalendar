...
MyQQuickCalendarModel::MyQQuickCalendarModel(QObject *parent) :
...
*/
QDate MyQQuickCalendarModel::visibleDate() const
{
    return mVisibleDate;
}
...
*/
void MyQQuickCalendarModel::setVisibleDate(const QDate &date)
{
...
/*!
    ...
    ...
*/
QLocale MyQQuickCalendarModel::locale() const
{
    return mLocale;
}
...
*/
void MyQQuickCalendarModel::setLocale(const QLocale &locale)
{
    if (locale != mLocale) {
...
QVariant MyQQuickCalendarModel::data(const QModelIndex &index, int role) const
{
    if (role == DateRole)
...
int MyQQuickCalendarModel::rowCount(const QModelIndex &) const
{
    return mVisibleDates.isEmpty() ? 0 : weeksOnACalendarMonth * daysInAWeek;
}

QHash<int, QByteArray> MyQQuickCalendarModel::roleNames() const
{
...
*/
QDate MyQQuickCalendarModel::dateAt(int index) const
{
...
*/
int MyQQuickCalendarModel::indexAt(const QDate &date)
{
...
*/
int MyQQuickCalendarModel::weekNumberAt(int row) const
{
...
*/
void MyQQuickCalendarModel::populateFromVisibleDate(const QDate &previousDate, bool force)
{
